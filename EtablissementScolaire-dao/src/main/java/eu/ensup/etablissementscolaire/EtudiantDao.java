...
public class EtudiantDao extends BaseDao implements IEtudiantDao {
	...
	public int create(Etudiant etudiant) throws DaoException {
		...
		try {
			...
			System.out.println("Erreur Sys Create Etudiant"+ e.getMessage());
			System.out.println("Erreur Sys Create Etudiant"+ e.getErrorCode());
			throw new CRUDException(e, Etudiant.class.getName(), "Create");
		}
		disconnect();
		System.out.println("Erreur Sys Create Etudiant"+ getResult());
		return getResult();
	}
