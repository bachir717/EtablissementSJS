            ...
            <div class="panel">
                <div class="panel-heading">
                    <div class="row">
                        <div class="col col-sm-3 col-xs-12">
                            <h4 class="title">Cours <span>List</span></h4>
                        </div>
                    </div>
                </div>
                <div class="panel-body table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                         <%
                          for(Cours c : (Set<Cours>) session.getAttribute("listCoursps")){
                         %>
                             <tr>
                               <td><%= c.getId()%></td>
                               <td><%= c.getTheme()%></td>
                              ...
                              <td>
                                <ul class="action-list">
                                  <li><a href="EditeCours.jsp" data-tip="edit"><i class="fa fa-edit"></i></a></li>
                                  <%--<li><a href="#" data-tip="delete"><i class="fa fa-trash"></i></a></li>--%>
                                  <li><a href="deleteCours?id=<%=c.getId()%>"><i class="fa fa-trash"></i></a></li>
                                </ul>
                               </td>
                            </tr>
                          <%
